...
- 🔗 Ontology-based Communication & Semantic Negotiation  
- 🌐 Distributed Systems & Event-Driven Architectures  
- 🚁 AI + Robotics (Vision-based autonomy)  

My focus is not just building applications — but engineering **systems of intelligence**.
...
- 🧩 **STRATON-LLM**  
  ...
  → Ontology alignment + structured argumentation for multi-agent systems  

- 🏗️ **Lattice v0.1**  
  Research-grade decentralized multi-agent framework  
  → Async execution, agent orchestration, knowledge graphs, negotiation  

- ⚡ Deepening expertise in  
  → AI systems design, distributed coordination, and intelligent architectures  
...
**Backend & Systems**
`FastAPI` `Node.js` `RabbitMQ` `gRPC` `REST`  

**AI / ML**
`LLMs` `CNN` `RL` `Deep Learning`  

**Agent Systems**
`LangChain` `LangGraph` `AutoGen`  

**Knowledge & Semantics**
`RDFlib` `Owlready2` `SPARQL`  
